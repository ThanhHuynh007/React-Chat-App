...
const firebaseConfig = {
  apiKey: "AIzaSyDe5gzePQWccoR211-4t10sgRAbWLt00nc",
  authDomain: "zenchat-25cfd.firebaseapp.com",
  projectId: "zenchat-25cfd",
  storageBucket: "zenchat-25cfd.appspot.com",
  messagingSenderId: "150577530338",
  appId: "1:150577530338:web:447438c25e44190730a5bb",
  measurementId: "G-98V5WN46Q0"
};
...
export const userRegister = async (value, email, password, username, downloadURL) => {
  try {
...
export const userUpdate = async (name, email, desc, downloadURL) => {
  try {
